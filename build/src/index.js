...
var _ProtectedRoute = __webpack_require__(19);

var _ProtectedRoute2 = _interopRequireDefault(_ProtectedRoute);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _ProtectedRoute2.default;
...
var ProtectedRoute = function ProtectedRoute(_ref) {
    var isAccessible = _ref.isAccessible,
        redirectToPath = _ref.redirectToPath,
        Component = _ref.component,
        rest = _objectWithoutProperties(_ref, ["isAccessible", "redirectToPath", "component"]);

    return _react2.default.createElement(_reactRouterDom.Route, _extends({}, rest, {
        render: function render(props) {
            return isAccessible ? _react2.default.createElement(Component, props) : _react2.default.createElement(_reactRouterDom.Redirect, {
                to: {
...
ProtectedRoute.propTypes = {
    isAccessible: _propTypes2.default.bool.isRequired,
    redirectToPath: _propTypes2.default.string.isRequired,
